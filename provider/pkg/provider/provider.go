...
func construct(ctx *pulumi.Context, typ, name string, inputs provider.ConstructInputs,
	...
	switch typ {
	case "aws:index:IamUser":
		return constructIamUser(ctx, name, inputs, options)
	default:
		return nil, errors.Errorf("unknown resource type %s", typ)
	}
}

func constructIamUser(ctx *pulumi.Context, name string, inputs provider.ConstructInputs,
	options pulumi.ResourceOption) (*provider.ConstructResult, error) {
	...
	staticPage, err := NewIamUse(ctx, name, args, options)
	if err != nil {
